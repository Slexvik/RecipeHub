...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(users.validators.ValidateUsername, models.Model),
            managers=[
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.CheckConstraint(check=models.Q(_negated=True, follower=django.db.models.expressions.F('following')), name='no_self_subscription'),
        ),
        migrations.AddConstraint(
            model_name='user',
